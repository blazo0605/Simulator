  ...
  return (
    <>
      <div>
        ...
        <p className="text-sm text-[--text-muted] mt-1">Prijavi se na nalog</p>
      </div>
      ...
      <form action={action} className="space-y-4">
        ...
        <GlassSubmit label="Prijavi se" pendingLabel="Prijavljivanje…" />
      </form>
  ...
  return (
    <motion.button
      ...
      className="flex items-center justify-center gap-2 w-full rounded-lg px-4 py-2.5
                 ...
                 transition-colors"
      style={{
        background: pending ? 'var(--accent-h)' : 'var(--accent)',
